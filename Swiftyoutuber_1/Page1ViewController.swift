...
//        cell.detailTextLabel!.text = self.publishedAtArray[indexPath.row]
    ...
    func getData() {
        ...
        var text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyB6rr_iBWUcJb6jJ65CC1Ii3mwzumSWPjo&q=那須川天心&part=snippet&maxResults=40&order=date"
...
//                    let publishedAt = json["items"][i]["snippet"]["publishedAt"].string
                    ...
                    let youtubeURL = "https://www.youtube.com/watch?=\(videoId!)"
